...
def new_lesson():
    ...
    return render_template("add_attendance_list.html", class_students=student_list_attendance, classes=classes_list,
...
def generate_raport():
    ...
    return send_file(output, download_name="raport_uczniow.xlsx", as_attachment=True,
